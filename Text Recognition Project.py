...
#decide which subject the image belongs to
        ...
        if max_subj == 'physics':
            ...
            try:
                ...
                src = image
                dst = r'C:\Users\bielp\Desktop\Text_recognition\physics'
                shutil.copy(src, dst)
            ...
            try:
                ...
                print("Adding", img_name, "to", dir_name)
                src = image
                dst = r'C:\Users\bielp\Desktop\Text_recognition\maths'
                shutil.copy(src, dst)
            ...
            try:
                ...
                print("Adding", img_name, "to", dir_name)
                src = image
                dst = r'C:\Users\bielp\Desktop\Text_recognition\biology'
                shutil.copy(src, dst)
